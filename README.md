...
generated by Puppet using the following snippet:
    ...
    @|"sh -c 'ls -d /etc/bareos/clients.d/*.conf /etc/bareos/jobs.d/*.conf /etc/bareos/filesets.d/*.conf | sed s/^/@/'"
...
default.  The schedules themselves must be (#non-module).

## Optional configuration

__`bareos::default_jobdef`__: Name of default job definition.
Defaults to `DefaultJob`.  The jobdef itself must be #(non-module).
